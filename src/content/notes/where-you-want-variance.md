...
sortOrder: 1
continuations: [{"target":{"kind":"essay","slug":"what-rules-cant-capture"}}]
---
...
Building systems that try to capture how I work, I've noticed the boundary between _that_ and _how_ isn't fixed. It moves.
...
This is what makes system design hard. The ability to specify something doesn't mean you should. Tools can make it easier to propose a specification, but a proposal does not establish that the underlying judgment has been captured.
...
The remaining _hows_ are places where I have deliberately kept discretion. Whether that makes the system more reliable is an empirical question; what I can observe is that it gives edge cases somewhere to remain open.
