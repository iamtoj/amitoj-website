...
test('home states the inquiry and completes the four-practice map below it', async ({ page }) => {
  await page.goto('/');

  const hero = page.locator('[data-home-hero]');
  await expect(hero).toContainText('I study how organizations decide what deserves attention and which direction is worth pursuing when measurement cannot settle either question.');
